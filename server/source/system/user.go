	...
	entities := []sysModel.SysUser{
		{
			...
			NickName:    "shnlly",
			HeaderImg:   "http://s7gh8x0zm.hd-bkt.clouddn.com/avatar-default.png?e=1705666826&token=OCHvv99yE5s6JAQPV8rENRk0mQvDbPz05bBJh2vz:tcBeZ-AxBQpl3JNg51bGOOBwbH0=",
			AuthorityId: 888,
			Phone:       "19811111111",
			Email:       "temp@qq.com",
		},
